...
if __name__ == '__main__':
    ...
    print(f"Il tuo sito é online qui: {public_url}")
    # Avviamo la logica del bidone in "sottofondo"
    t = threading.Thread(target=logica_bidone)
    t.daemon = True
    t.start()
